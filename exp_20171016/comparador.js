...
Comparador.prototype.pintaFilasArray = function(posicion){	
	...
	texto += "<tr><td>"+listaKeys[posicion]+"</td>";
	for (var i = 0; i < this.listaObjetos.length; i++) {
		listaValores = this.getValor(i);
...
/*getKeysArray busca entre las keys del objeto y te devuelve las que son arrays 


*/
Comparador.prototype.getKeysArray = function(){

	var listaKeys = this.getKeys();
	var listaValores = this.getValor();
