...
Metodos:
	...
	this.pintarTitulos(titulos):
						...
						y tambien se crea el boton con la clase eliminaRecurso.
						Usa el atributo this.titulo para saber en que key esta el nombre del titulo.
