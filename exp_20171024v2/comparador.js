...
function Comparador(){
	...
	this.arrayKeysOrdenPintado = new Array("tipus", "gratuit", "tematica", "territori");
...
Comparador.prototype.esArray = function(arrayPintar, key){
...
Comparador.prototype.pintando = function(){
	...
	for (var i = 0; i < keyArray.length; i++) {
		...
		for (var x = 0; x < this.listaObjetos.length; x++) {


			//textoHtml += "<td>"+this.listaObjetos[x][this.arrayKeysOrdenPintado[i]]+"</td>";
			if (Array.isArray(this.listaObjetos[x][keyArray[i]])) {
				textoHtml += this.esArray(this.listaObjetos[x][this.arrayKeysOrdenPintado[i]], keyArray[i]);
			}
...
//Frontera de los metodos que no usar_________________________
