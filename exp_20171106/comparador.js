...
Comparador.prototype.pintaTabla = function(idHtml){
	...
	if (this.listaObjetos.length < 4) {
		var textoHtml ="<div id='contenedorBotonAgregar'><button class='addRecurso' onclick='addRecurso();'> <span class='glyphicon glyphicon-plus-sign'></span> Nou recurs</button></div>";
		//alert("Ahora");
