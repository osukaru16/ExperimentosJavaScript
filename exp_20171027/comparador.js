...
Comparador.prototype.pintarTitulos = function(titulos){
	...
	for (var i = 0; i < this.listaObjetos.length; i++) {
		...
		textoHtml += "<th>"+this.listaObjetos[i][titulos]+"<button onclick='eliminaRecurso(\""+this.listaObjetos[i][this.id]+"\");' >X</button> </th>";
	}
...
Comparador.prototype.pintaOtros = function(key){
	...
	textoHtml += "<tr><td class='titulosPropiedades'>"+key+"</td>";
